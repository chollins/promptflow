...
def upgrade():
    ...
    with op.batch_alter_table('flow_form_steps', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('flow_id'))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('flow_form_steps', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('flow_id'), ['flow_id', 'step_number'], unique=True)
